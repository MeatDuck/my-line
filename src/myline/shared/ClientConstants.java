...
public class ClientConstants {
	...
	public static final String cwDialogBoxCaption = "Короткие ссылки";	
	public static final String cwDialogBoxDetails = "Вставьте URL в поле ввода и нажмите ОК";
	public static final String cwDialogBoxClose = "OK";
